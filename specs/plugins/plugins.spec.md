...
| `specs`       | нет   | `specs`        | Каталог спек; root-спека — `<specs>/<id>.spec.md` (§4.4) |
...
6. Удалить `specs/stack/plugins/` (её содержимое переезжает в `plugins/<id>/specs/`), `ai/directives/infra/golang-setup.xml`, `ai/skills/sdd-infra-golang/`.
