...
| Пакет           | `npm pack`, `prepare-publish-artifacts`     | `files` включает каталоги плагинов (манифест, entry, directives, skills); тест содержимого тарбола |
