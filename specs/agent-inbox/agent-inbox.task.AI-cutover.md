# Task: AI-cutover — Wire journal-first runtime and retire legacy role orchestration
...
- **Dependencies:** IV-vcs-port, IO-runtime, IP-control, IQ-actions, IC-handoff, IA-proj, IM-cases
- **Spec References:** [Architecture](./agent-inbox.spec.md#5-high-level-architecture), [Module Map](./agent-inbox.spec.md#9-module-map)
...
- **Inputs:** IV-vcs-port–180 handoffs
...
| `npm test -- services/agent-inbox/serve/__tests__/ services/agent-inbox/__tests__/` | testing-common, node-test | probe |
