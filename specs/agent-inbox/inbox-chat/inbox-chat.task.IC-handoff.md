# Task: IC-handoff — MR chat, artifact mutation and full/delta DEV handoff
...
- **Scope:** agent-inbox
- **Module:** inbox-chat
- **Dependencies:** IC-state, IO-runtime, IP-control, IQ-actions
- **Spec References:** [Chat inventory](./inbox-chat.spec.md#3-entity-inventory-closed-world), [Handoff DbC](./inbox-chat.spec.md#5-module-contracts-dbc)
- **Runtime Backing:** `real-runtime`
- **Verification Levels:** `contract`, `unit`, `integration`
- **Deferred Runtime Scope:** browser clipboard write owned by ID-cockpit
  <!--/SECTION:META-->
...
| `npm test -- services/agent-inbox/modules/inbox-chat/__tests__/` | testing-common, node-test | probe |
