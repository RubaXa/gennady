# Task: IO-runtime — Agent runtime contracts, sessions and coverage traces
...
- **Spec References:** [Inventory](./inbox-opencode.spec.md#3-entity-inventory-closed-world), [Contracts](./inbox-opencode.spec.md#5-module-contracts-dbc)
...
| `node --import tsx --test --experimental-test-module-mocks services/agent-inbox/modules/inbox-opencode/__tests__/*.test.ts` | testing-common, node-test | extra |
...
- [x] 2026-08-10T19:54:01Z ver `node --import tsx --test --experimental-test-module-mocks --experimental-test-coverage <IO-runtime test files>` → pass exit=`0` (5 tests; coverage report emitted)
...
- [x] 2026-08-11T08:34:30Z ver `focused IO-runtime tests` → pass exit=`0` (18 tests)
...
- [x] 2026-08-11T08:34:30Z ver `npx prettier --check <IO-runtime scope>` → pass exit=`0`
...
- [x] 2026-08-11T09:04:25Z ver focused IO-runtime → pass `18/18`; full inbox-opencode → pass `164/164`; affected runtime regression → pass `52/52`; IV-vcs-port compatibility smoke → pass `7/7`
