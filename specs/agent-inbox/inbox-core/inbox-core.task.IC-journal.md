# Task: IC-journal — Bootstrap: журнал событий + per-MR layout
...
- **Dependencies:** None
- **Spec References:**
  - Module spec: [inbox-core](./inbox-core.spec.md) §2 (JournalPort), §3, §6
  - Bootstrap: [root §12](../agent-inbox.spec.md)
...
| `npm test -- services/agent-inbox/modules/inbox-core/__tests__/event-journal.test.ts` | node-test        | probe |
