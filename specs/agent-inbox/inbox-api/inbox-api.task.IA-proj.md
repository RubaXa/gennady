# Task: IA-proj — Journal projections and typed local API
...
- **Scope:** agent-inbox
- **Module:** inbox-api
- **Dependencies:** IC-state, IV-vcs-port, IP-control, IQ-actions, IC-handoff
- **Spec References:** [API inventory](./inbox-api.spec.md#3-entity-inventory-closed-world), [DbC](./inbox-api.spec.md#5-module-contracts-dbc)
...
| `npm test -- services/agent-inbox/modules/inbox-api/__tests__/` | testing-common, node-test | probe |
