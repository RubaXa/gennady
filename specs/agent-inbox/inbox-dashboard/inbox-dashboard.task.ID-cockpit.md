# Task: ID-cockpit — Carbon & Steel operator dashboard and MR workspace
...
- **Dependencies:** IC-handoff, IA-proj, IM-cases, AI-cutover
- **Spec References:** [Dashboard inventory](./inbox-dashboard.spec.md#3-entity-inventory-closed-world), [DbC](./inbox-dashboard.spec.md#5-module-contracts-dbc), [Design](./design-system.md)
...
| `npm test -- services/agent-inbox/modules/inbox-dashboard/__tests__/` | testing-common, node-test      | probe |
| `npm run inbox-serve:build && npm run test:e2e:prod`                  | playwright-cli, playwright-e2e | probe |
