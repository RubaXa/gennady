# Task: VC-approve — Метод approve на MergeRequests порте
...
- **Spec References:**
  - Scope spec: [vcs.spec.md §FR-26..FR-29](../vcs.spec.md)
  - Port: [VcsClientMergeRequests](./vcs-client.spec.md#vcsclientmergerequests)
  - Value Object: [VcsMergeRequestApproveQuery](./vcs-client.spec.md)
...
| `node --import tsx --test services/vcs-client/gitlab/__tests__/vcs-gitlab-merge-requests.approve.test.ts` | node-test        | extra |
