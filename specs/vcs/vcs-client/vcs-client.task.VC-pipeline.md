# Task: VC-pipeline — getPipeline порт + адаптер

<!--SECTION:META-->

## 1. Meta

- **Task-ID:** VC-pipeline | **Status:** [ ] TODO | **Scope:** vcs | **Module:** vcs-client | **Dependencies:** None
...
- **Target Files:**
  - `services/vcs-client/entities/vcs-pipeline-status.type.ts`
...
**Scenario:** Ошибка: GraphQL transport не настроен [`unit`]

- **Given** client без GraphQL transport
- **When** adapter запрашивает pipeline
- **Then** вызов отклоняется с ошибкой
...
- [x] `2026-06-26T18:34:05Z` intro VcsGitlabMergeRequests.getPipeline test file ← VC-pipeline P2: covers happy path, absent pipeline, missing graphql transport, type contract
