# Task: VC-resolve — Метод resolveDiscussion на MergeDiscussions порте
...
- **Reopens:** 0
- **Spec References:**
  - Scope spec: [vcs.spec.md §FR-30..FR-34](../vcs.spec.md)
  - Port: [VcsClientMergeDiscussions](./vcs-client.spec.md)
...
| `node --import tsx --test services/vcs-client/gitlab/__tests__/vcs-gitlab-merge-discussions.resolve.test.ts` | node-test        | extra |
...
```
@audit task=VC-resolve round=1 after-exec-round=1 triggered-reopen=Round-2 status=FAIL counts=B0·M1·m0·I0
