# Task: VC-url — vcs-client: Entities + URL parser
...
- **Dependencies:** None
- **Spec References:**
  - [`VcsUrl`](./vcs-client.spec.md#vcsurl)
  - [`VcsMergeRequestChanges`](./vcs-client.spec.md#vcsmergerequestchanges)
  - [`VcsFileContent`](./vcs-client.spec.md#vcsfilecontent)
  - [`parseVcsUrl`](./vcs-client.spec.md#parsevcsurl)
...
- **Completion additions:** file headers `// @tasks: VC-url` на новые файлы
...
- Scenario Невалидный URL — не MR/PR → `services/vcs-client/__tests__/parse-vcs-url.test.ts` :: `returns null for non-MR GitLab URL (issues)`
