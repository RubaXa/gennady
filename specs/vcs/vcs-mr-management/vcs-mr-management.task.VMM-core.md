# Task: VMM-core — API core: query types + abstract port for MR create/update
...
- **Runtime Backing:** `not-implemented` (abstract; адаптеры — в VMM-glcreate, VMM-gh-crud)
...
| `node --import tsx --test services/vcs-client/__tests__/abstract/vcs-client-merge-requests.test.ts` | node-test        | extra |
