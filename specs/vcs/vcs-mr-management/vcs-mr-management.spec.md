...
| **CLI: vcs-discussions**     |                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| FR-MR-17                     | `vcs-discussions` — показать дискуссии MR. Использует `resolveVcsContext`. Обязательные: `--ref <group/repo!iid>` (или `--project` + `--iid`). Опциональные: `--all` (включить resolved), `--draft` (draft notes вместо discussions), `--since <iso-timestamp>` (треды после курсора), `--json` (машинный вывод), `--host` / `--vcs-host`                                                                                          |
...
| FR-MR-19a                    | Пустой результат → stdout `No discussions found for group/repo!42`, exit 0; при `--json` → `[]`                                                                                                                                                                                                                                                                                                                                    |
| FR-MR-19b                    | `--json` вывод: массив объектов `[{ id, fullId, shortId, author, body, file?, line?, resolved, updatedAt?, notes: [{ author, body, createdAt }] }]`. Поля `file`/`line` отсутствуют для общих дискуссий. `notes` — массив всех заметок в треде (первая — открывающая, остальные — ответы)                                                                                                                                          |
| **Shared**                   |                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
| FR-MR-21                     | Все CLI-команды поддерживают `--host` / `--vcs-host` для self-hosted инсталляций                                                                                                                                                                                                                                                                                                                                                   |
...
| FR-MR-27                     | Git отсутствует в PATH → stderr `✖ git не найден — установите git и повторите`, exit 1                                                                                                                                                                                                                                                                                                                                             |
| FR-MR-28                     | Не git-репозиторий → stderr: `✖ Не удалось определить текущую ветку: не найден git-репозиторий.`, exit 1                                                                                                                                                                                                                                                                                                                           |
| FR-MR-29                     | Detached HEAD → stderr `✖ HEAD не указывает на ветку — укажите source branch явно`, exit 1                                                                                                                                                                                                                                                                                                                                         |
