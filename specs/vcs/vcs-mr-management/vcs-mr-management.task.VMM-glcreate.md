# Task: VMM-glcreate — GitLab adapter: MR create + update

<!--SECTION:META-->

## 1. Meta

- **Task-ID:** VMM-glcreate
- **Status:** [ ] TODO
...
- **Reopens:** 0
- **Spec References:**
  - Scope spec: [vcs-mr-management.spec.md §3](../../../specs/vcs/vcs-mr-management/vcs-mr-management.spec.md) — `VcsGitlabMergeRequests.create`, `.update`; FR-MR-02, FR-MR-06, FR-MR-08, D-001
...
**Scenario:** Ошибка duplicate prefix предотвращена при update draft + title [`unit`]
...
| `node --import tsx --test services/vcs-client/gitlab/__tests__/vcs-gitlab-merge-requests.create-update.test.ts` | node-test        | extra |
