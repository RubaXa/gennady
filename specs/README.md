...
| [`stack-plugins`](./stack-plugins/stack-plugins.spec.md)             | infrastructure | 🚧   | Локальность плагинов: `stack-plugins/<id>/` — единственное хранилище файлов стека (код, спека, директивы, скиллы, фикстуры); манифест + резолвер; дизайн внешних плагинов (D-STACK-001)                         |
