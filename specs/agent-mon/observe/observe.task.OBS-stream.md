# Task: OBS-stream — observe: async iterable
...
- **Scope:** agent-mon
- **Module:** observe
- **Dependencies:** MOD-types, MON-service, DIF-compare
- **Spec References:**
  - Contract: [`observe`](./observe.spec.md#observe)
  - Service: [`AgentMonitor`](../monitor/monitor.spec.md#agentmonitor)
  - Function: [`diff`](../diff/diff.spec.md#diff)
  - Scope: [`agent-mon` §3.1 F8`, §2 Golden DX](../agent-mon.spec.md)
