...
**Scenario:** Ошибка: scan возвращает [] если директория не существует [`unit`]
...
_(Token vocabulary in [tasks/README.md#execution-log-template](../../tasks/agent-mon/README.md#execution-log-template).)_

### Round 1 — initial

#### P1

- [x] `2026-05-22T05:29:46Z` intro `idleThresholdMs` на `ScanOpts` ← требуется для idle-детекции в scan(); поле отсутствовало в MOD-types
