# Task: OPE-adapter — Implement opencode engine
...
- **Scope:** agent-run
- **Module:** opencode
- **Dependencies:** COR-engine
- **Spec References:**
  - Module spec: [opencode](./opencode.spec.md)
  - Adapter: [`OpencodeEngine`](./opencode.spec.md#opencodeengine)
  - Utility: [`opencodeErrorMap`](./opencode.spec.md#opencodeerrormap)
  - Port: [`AgentEngine`](../core/core.spec.md#agentengine)
  - Constraints: [agent-run §3.2 N4/N6, §3.4](../agent-run.spec.md#3-requirements--constraints)
...
- **Inputs:** none (потребляет контракт `core` из COR-engine через импорт)
