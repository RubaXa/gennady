# Task: CLI-reopen — vcs-reply: resolve/reopen discussion через stdin JSON
...
- **Dependencies:** VC-resolve
- **Reopens:** 0
- **Spec References:**
  - Scope spec: [cli.spec.md §4.1.13, D-018](./cli.spec.md)
...
- **Inputs:** VC-resolve handoff (resolveDiscussion)
...
| `node --import tsx --test cli/cmd/vcs-reply/__tests__/vcs-reply.resolve.test.ts` | node-test              | extra |
| `node --import tsx --test cli/cmd/vcs-reply/__tests__/vcs-reply.cmd.test.ts`     | node-test (regression) | extra |
