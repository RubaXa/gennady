# Task: CLI-vcs-ctx — vcs-context-resolver: унифицированный резолв VCS-контекста
...
- **Spec References:**
  - Scope spec: [cli.spec.md §4.1.14, §5.16, D-015](./cli.spec.md)
  - Contract: [VcsCliContext, VcsCliArgs, VcsCliDeps](./cli.spec.md#4114-vcs-context-resolver-shared)
...
| `node --import tsx --test cli/cmd/_shared/__tests__/vcs-context-resolver.test.ts` | node-test        | extra |
...
- Невалидный VCS URL → `vcs-context-resolver.test.ts` :: `garbage URL — throws VcsResolveError`
