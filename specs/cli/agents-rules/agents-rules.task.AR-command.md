# Task: AR-command — Реализовать agents-rules
...
- **Dependencies:** None
- **Spec References:**
  - Module spec: [agents-rules.spec.md](./agents-rules.spec.md)
  - Parent spec §4.1.7: [Functional Requirements](../cli.spec.md) (FR-AR-01…06)
  - Parent spec §5.10: [Architecture](../cli.spec.md)
  - Content spec: [Parent §3.7 Golden DX](../cli.spec.md)
...
| ------------------------------------------------------------------------------------------------------ | ---------------- | ----- |
| `tsc --noEmit -p tsconfig.json`                                                                        | typescript-rules | extra |
| `node --test --experimental-test-module-mocks cli/cmd/agents-rules/__tests__/agents-rules.cmd.test.ts` | node-test        | extra |
