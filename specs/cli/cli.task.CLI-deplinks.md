# Task: CLI-deplinks — vcs-worktree: детерминированный симлинкинг зависимостей (FR-WT-07)

<!--SECTION:META-->

## 1. Meta

- **Task-ID:** CLI-deplinks
- **Status:** [ ] TODO
...
- **Dependencies:** None
- **Spec References:**
  - Scope spec: [cli.spec.md §4.1.12 FR-WT-07, D-019](./cli.spec.md#4112-vcs-worktree-functional-requirements)
...
| `node --import tsx --test cli/cmd/vcs-worktree/_core/logic/worktree-links.test.ts` | node-test        | extra |
