# Task: UC-tests — Tests: update-check (unit + integration)
...
- **Inputs:** UC-notify P2 handoff
- **Exit:** все BDD-сценарии из UC-notify §4 покрыты; `npm test` pass
...
Перенесены из UC-notify §4. Contract: see Spec References.
