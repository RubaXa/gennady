# Task: CLI-alt-tele — AltOpinion Telemetry

<!--SECTION:META-->

## 1. Meta & Traceability

- **Task-ID:** CLI-alt-tele
...
- **Scope:** cli
- **Module:** alt-opinion
- **Dependencies:** CLI-alt-core, CLI-alt-cli, CLI-alt-test
- **Spec References:**
  - FR-ALT-18..21: [cli spec §4.1.2](../../specs/cli/cli.spec.md)
  - NFC-09: [cli spec §4.2](../../specs/cli/cli.spec.md)
- **Historical References:** D-005: `alt-opinion.spec.md` §6 (superseded by the scope spec)
