# Task: CLI-reg-vcs — Интеграция: регистрация команд в gennady.ts + help + README
...
- **Module:** `integration`
- **Dependencies:** CLI-mrcreate, CLI-mr-edit, CLI-discuss
...
| `npx gennady help` (ручная проверка) | —                | extra |
