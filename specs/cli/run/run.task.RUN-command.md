# Task: RUN-command — gennady run command
...
- **Scope:** cli
- **Module:** run
- **Dependencies:** COR-model
- **Spec References:**
  - DX: [cli §3.8 run DX](../cli.spec.md#38-run-dx)
  - FR: [cli §4.1.9 run Functional Requirements](../cli.spec.md#419-run-functional-requirements)
  - Arch: [cli §5.13 run](../cli.spec.md#513-run)
  - Library: [agent-run §4 Public API](../../agent-run/agent-run.spec.md#4-public-api-surface)
...
- **Target Files:**
  ...
  - `cli/cmd/run/help.ts`
  - `cli/AGENTS.md`
- **Inputs:** none (потребляет `@services/agent-run` из COR-model)
