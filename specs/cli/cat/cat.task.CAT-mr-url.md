# Task: CAT-mr-url — cat --url: поддержка GitLab MR / GitHub PR
...
- **Scope:** cli
- **Module:** cat
- **Dependencies:** VC-github
- **Spec References:**
  - [cat.spec.md](./cat.spec.md) §5 (архитектура), §6 (Decision Log D-001..D-005)
  - [VcsGithubMergeRequests](../../vcs/vcs-client/vcs-client.spec.md#vcsgithubmergerequests)
...
| `node --test cli/cmd/cat/__tests__/cat-url.test.ts cli/utils/cat-gen/__tests__/cat-gen-from-vcs.test.ts` | node-test        | extra |
| `npx prettier --check cli/cmd/cat/ cli/utils/cat-gen/`                                                   | prettier (infra) | extra |
