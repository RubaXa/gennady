# Task: SS-skills — ai/skills bootstrap (13 SDD-скилов)
...
- **Dependencies:** SS-command
- **Spec References:**
  - Module spec: [`sync-skills.spec.md`](./sync-skills.spec.md) §6 (ai/skills/ структура)
  - Bootstrap: [`cli.spec.md §8`](../cli.spec.md)
...
**Scenario:** Запрещённый .DS_Store отсутствует в ai/skills/ [`contract`]
...
| ------------------------------- | ----------- | ----- |
| `find ai/skills -name SKILL.md` | manual      | probe |
