# Task: CLI-alt-test — AltOpinion Tests (parser + runner + integration)

<!--SECTION:META-->

## 1. Meta & Traceability

- **Task-ID:** CLI-alt-test
- **Purpose:** Unit-тесты парсера (13 кейсов), runner (11 кейсов с DI-моками), CLI-интеграция (12 кейсов).
- **Scope:** cli
- **Module:** alt-opinion
- **Dependencies:** CLI-alt-core, CLI-alt-cli
- **Spec References:**
  - alt-opinion FR: [cli spec §4.1.2](../../specs/cli/cli.spec.md)
- **Historical References:** `alt-opinion.spec.md` §3 (superseded by the scope spec)
- **Status:** [x] DONE
