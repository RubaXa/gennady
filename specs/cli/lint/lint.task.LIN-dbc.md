...
- **Scope:** cli
- **Module:** lint
- **Dependencies:** LIN-types, DL-content
- **Spec References:**
...
- [x] `[2026-05-15T19:10:00Z]` intro DbcContractCheck.check ← фаза P1 LIN-dbc: адаптер к DbcTsLinter с передачей контента
