# Task: LIN-disable — Implement DisablesCheck (TypeScript/Linter disable discipline)
...
- **Scope:** `cli`
- **Module:** `lint`
- **Dependencies:** LIN-dir-test
- **Spec References:**
  - Policy: [`cli.spec.md` D-007](../cli.spec.md)
  - Service: [`DisablesCheck`](./lint.spec.md)
  - DbC: [`Service: DisablesCheck`](./lint.spec.md)
  - Test Scenarios: [`§6.1 DisablesCheck`](./lint.spec.md)
  - Authorized exception: [`vcs-client.spec.md` D-001](../../vcs/vcs-client/vcs-client.spec.md)
...
Contract: см. Spec References. Полный список — [`lint.spec.md §6.1 DisablesCheck`](./lint.spec.md).
