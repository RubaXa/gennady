...
| `DbcValidateContext`        | Value Object | Контекст для `validate()`: `implementsInterfaces?: string[]` (имена интерфейсов), `memberName?: string` (имя метода для @see-матчинга внутри validate()) |
