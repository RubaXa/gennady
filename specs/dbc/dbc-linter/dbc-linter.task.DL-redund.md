# Task: DL-redund — Реализовать `removeRedundantInImplements` в autofix-цепочке
...
| `node --import tsx --test **/*.test.ts` | node-test        | extra |
