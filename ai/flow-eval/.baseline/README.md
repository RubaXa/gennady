...
- `rc-evidence-pack/` — REL-18: raw logs, exit codes and environment for the final release gates,
  all captured against one clean immutable commit; generated by `npm run release:evidence-pack` and
  independently checked by `npm run release:evidence-pack:check`.
- `README.md` — this file.
