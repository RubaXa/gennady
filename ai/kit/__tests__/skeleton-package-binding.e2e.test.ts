...
describe('SkeletonPackageBindingGuard — end-to-end via sdd-step', () => {
  it(
    ...
    () => {
      // Intentionally empty: mechanism A (skeleton path + plain Read) has no CLI in the loop today
      // (DA-DL-12) — this placeholder exists so the deferred surface stays visible in the test tree
