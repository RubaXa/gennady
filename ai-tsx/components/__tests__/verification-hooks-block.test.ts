// @file: VerificationHooksBlock unit tests — fixture-driven XML rendering.
...
import { VerificationHooksBlock } from '../verification-hooks-block.js';
...
describe('VerificationHooksBlock', () => {
  it('renders verification-hooks-block with children', async () => {
    const dir = join(fixturesDir, 'verification-hooks-block');
