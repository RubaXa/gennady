// @file: DefinitionsBlock unit tests — fixture-driven XML rendering.
...
import { DefinitionsBlock } from '../definitions-block.js';
...
describe('DefinitionsBlock', () => {
  it('renders definitions-block with children', async () => {
    const dir = join(fixturesDir, 'definitions-block');
