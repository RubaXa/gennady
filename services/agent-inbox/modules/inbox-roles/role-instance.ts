...
import {
  ...
  type DisputeSummary,
} from './role-instance/escalation-gate.ts';
import {
  extractFindings,
  extractVerdict,
...
export class RoleInstance {
   ...
   */
  protected _extractFindings(): ReturnType<typeof extractFindings> {
    return extractFindings(this._artifacts);
  }
  ...
  protected _extractVerdict(): string {
    return extractVerdict(this._artifacts, this.state);
  }
  ...
  protected _collectProposedActions(): ProposedAction[] {
    return collectProposedActions(this._artifacts);
  }
  ...
  protected _findNode(nodeId: string): RoleNode | undefined {
    return findNode(this._graph, nodeId);
  }
  ...
  protected _resolveEdge(fromNodeId: string, condition: EdgeCondition): Edge | undefined {
    return resolveEdge(this._graph, fromNodeId, condition);
  }
