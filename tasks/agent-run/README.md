...
|---------|-------|--------|--------------|--------|---------|
| [TSK-62](core/core.task-62.md) | Implement core module | core | None | `[ ]` TODO | 0 |
| [TSK-63](opencode/opencode.task-63.md) | Implement opencode engine | opencode | TSK-62 | `[ ]` TODO | 0 |
