...
- [x] `<ts>` tried node --test cli/cmd/lint/**tests**/ → MODULE_NOT_FOUND (Node 22 does not load directories directly; glob required)
- [x] `<ts>` ver node --test "cli/cmd/lint/**tests**/\*.test.ts" → pass exit=0
- [x] `<ts>` DONE
