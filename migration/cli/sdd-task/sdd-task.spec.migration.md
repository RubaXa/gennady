# План миграции: specs/cli/sdd-task/sdd-task.spec.md

- **Status:** APPROVED <!-- PLANNED → MAPPED → APPROVED → DONE -->
- **Scope:** cli | **Module:** sdd-task
...
- spec: `specs/cli/sdd-task/sdd-task.spec.md` · строк: 306 · scope-type: — · mermaid-блоков: 0 · якорей: 8
...
<!-- Новый ID: `<ACR>-<slug>` — kebab-case, слаг из Meta.Purpose, слаг ≤8 символов (дефисы включительно), уникален в рамках всего репо.
     Назначение вычисляется из ID: `specs/cli/sdd-task/sdd-task.task.<новый-ID>.md`. -->
