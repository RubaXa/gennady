# План миграции: specs/cli/sdd-migrate/sdd-migrate.spec.md

- **Status:** APPROVED <!-- PLANNED → MAPPED → APPROVED → DONE -->
- **Scope:** cli | **Module:** sdd-migrate
...
- spec: `specs/cli/sdd-migrate/sdd-migrate.spec.md` · строк: 242 · scope-type: — · mermaid-блоков: 0 · якорей: 10
...
<!-- Новый ID: `<ACR>-<slug>` — kebab-case, слаг из Meta.Purpose, слаг ≤8 символов (дефисы включительно), уникален в рамках всего репо.
     Назначение вычисляется из ID: `specs/cli/sdd-migrate/sdd-migrate.task.<новый-ID>.md`. -->
