# План миграции: specs/cli/sdd-sync/sdd-sync.spec.md

- **Status:** APPROVED <!-- PLANNED → MAPPED → APPROVED → DONE -->
- **Scope:** cli | **Module:** sdd-sync
...
- spec: `specs/cli/sdd-sync/sdd-sync.spec.md` · строк: 180 · scope-type: — · mermaid-блоков: 0 · якорей: 8
...
<!-- Новый ID: `<ACR>-<slug>` — kebab-case, слаг из Meta.Purpose, слаг ≤8 символов (дефисы включительно), уникален в рамках всего репо.
     Назначение вычисляется из ID: `specs/cli/sdd-sync/sdd-sync.task.<новый-ID>.md`. -->
