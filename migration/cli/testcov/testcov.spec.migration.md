# План миграции: specs/cli/testcov/testcov.spec.md

- **Status:** APPROVED <!-- PLANNED → MAPPED → APPROVED → DONE -->
- **Scope:** cli | **Module:** testcov
...
- spec: `specs/cli/testcov/testcov.spec.md` · строк: 524 · scope-type: — · mermaid-блоков: 0 · якорей: 10
...
<!-- Новый ID: `<ACR>-<slug>` — kebab-case, слаг из Meta.Purpose, слаг ≤8 символов (дефисы включительно), уникален в рамках всего репо.
     Назначение вычисляется из ID: `specs/cli/testcov/testcov.task.<новый-ID>.md`. -->

| Файл                                       | Task-ID | Новый ID | Назначение                                   |
| ------------------------------------------ | ------- | -------- | -------------------------------------------- |
| `tasks/cli/testcov/cli-testcov.task-66.md` | TSK-66  | TES-tree | `specs/cli/testcov/testcov.task.TES-tree.md` |
