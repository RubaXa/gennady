# План миграции: specs/cli/sdd-new/sdd-new.spec.md

- **Status:** APPROVED <!-- PLANNED → MAPPED → APPROVED → DONE -->
- **Scope:** cli | **Module:** sdd-new
...
- spec: `specs/cli/sdd-new/sdd-new.spec.md` · строк: 326 · scope-type: — · mermaid-блоков: 0 · якорей: 8
...
<!-- Новый ID: `<ACR>-<slug>` — kebab-case, слаг из Meta.Purpose, слаг ≤8 символов (дефисы включительно), уникален в рамках всего репо.
     Назначение вычисляется из ID: `specs/cli/sdd-new/sdd-new.task.<новый-ID>.md`. -->
