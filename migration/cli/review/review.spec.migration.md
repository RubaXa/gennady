# План миграции: specs/cli/review/review.spec.md

- **Status:** APPROVED <!-- PLANNED → MAPPED → APPROVED → DONE -->
- **Scope:** cli | **Module:** review
...
- spec: `specs/cli/review/review.spec.md` · строк: 321 · scope-type: — · mermaid-блоков: 0 · якорей: 0
...
<!-- Новый ID: `<ACR>-<slug>` — kebab-case, слаг из Meta.Purpose, слаг ≤8 символов (дефисы включительно), уникален в рамках всего репо.
     Назначение вычисляется из ID: `specs/cli/review/review.task.<новый-ID>.md`. -->
