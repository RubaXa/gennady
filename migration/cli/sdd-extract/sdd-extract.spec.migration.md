# План миграции: specs/cli/sdd-extract/sdd-extract.spec.md

- **Status:** APPROVED <!-- PLANNED → MAPPED → APPROVED → DONE -->
- **Scope:** cli | **Module:** sdd-extract
...
- spec: `specs/cli/sdd-extract/sdd-extract.spec.md` · строк: 212 · scope-type: — · mermaid-блоков: 0 · якорей: 12
...
<!-- Новый ID: `<ACR>-<slug>` — kebab-case, слаг из Meta.Purpose, слаг ≤8 символов (дефисы включительно), уникален в рамках всего репо.
     Назначение вычисляется из ID: `specs/cli/sdd-extract/sdd-extract.task.<новый-ID>.md`. -->
