# План миграции: specs/cli/help/help.spec.md

- **Status:** APPROVED <!-- PLANNED → MAPPED → APPROVED → DONE -->
- **Scope:** cli | **Module:** help
...
- spec: `specs/cli/help/help.spec.md` · строк: 217 · scope-type: — · mermaid-блоков: 0 · якорей: 0
...
<!-- Новый ID: `<ACR>-<slug>` — kebab-case, слаг из Meta.Purpose, слаг ≤8 символов (дефисы включительно), уникален в рамках всего репо.
     Назначение вычисляется из ID: `specs/cli/help/help.task.<новый-ID>.md`. -->
