# План миграции: specs/cli/sdd-step/sdd-step.spec.md

- **Status:** APPROVED <!-- PLANNED → MAPPED → APPROVED → DONE -->
- **Scope:** cli | **Module:** sdd-step
...
- spec: `specs/cli/sdd-step/sdd-step.spec.md` · строк: 557 · scope-type: — · mermaid-блоков: 3 · якорей: 12
...
<!-- Новый ID: `<ACR>-<slug>` — kebab-case, слаг из Meta.Purpose, слаг ≤8 символов (дефисы включительно), уникален в рамках всего репо.
     Назначение вычисляется из ID: `specs/cli/sdd-step/sdd-step.task.<новый-ID>.md`. -->
