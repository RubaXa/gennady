# План миграции: specs/cli/sdd-log/sdd-log.spec.md

- **Status:** APPROVED <!-- PLANNED → MAPPED → APPROVED → DONE -->
- **Scope:** cli | **Module:** sdd-log
...
- spec: `specs/cli/sdd-log/sdd-log.spec.md` · строк: 317 · scope-type: — · mermaid-блоков: 0 · якорей: 8
...
<!-- Новый ID: `<ACR>-<slug>` — kebab-case, слаг из Meta.Purpose, слаг ≤8 символов (дефисы включительно), уникален в рамках всего репо.
     Назначение вычисляется из ID: `specs/cli/sdd-log/sdd-log.task.<новый-ID>.md`. -->
