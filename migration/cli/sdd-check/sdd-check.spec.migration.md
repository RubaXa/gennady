# План миграции: specs/cli/sdd-check/sdd-check.spec.md

- **Status:** APPROVED <!-- PLANNED → MAPPED → APPROVED → DONE -->
- **Scope:** cli | **Module:** sdd-check
...
- spec: `specs/cli/sdd-check/sdd-check.spec.md` · строк: 444 · scope-type: — · mermaid-блоков: 0 · якорей: 9
...
<!-- Новый ID: `<ACR>-<slug>` — kebab-case, слаг из Meta.Purpose, слаг ≤8 символов (дефисы включительно), уникален в рамках всего репо.
     Назначение вычисляется из ID: `specs/cli/sdd-check/sdd-check.task.<новый-ID>.md`. -->
