# План миграции: specs/vcs/vcs-github-cli/vcs-github-cli.spec.md

- **Status:** APPROVED <!-- PLANNED → MAPPED → APPROVED → DONE -->
- **Scope:** vcs | **Module:** vcs-github-cli
...
- spec: `specs/vcs/vcs-github-cli/vcs-github-cli.spec.md` · строк: 91 · scope-type: — · mermaid-блоков: 0 · якорей: 0
...
| `## 4. Architecture`                    | keep     | ARCHITECTURE                 | предзаполнено правилом                  |
| `## 5. Parent Spec Amendments`          | keep     | PARENT_SPEC_AMENDMENTS       | дельта родительской спеки сохраняется   |
...
<!-- Новый ID: `<ACR>-<slug>` — kebab-case, слаг из Meta.Purpose, слаг ≤8 символов (дефисы включительно), уникален в рамках всего репо.
     Назначение вычисляется из ID: `specs/vcs/vcs-github-cli/vcs-github-cli.task.<новый-ID>.md`. -->
