# План миграции: specs/vcs/vcs.spec.md
...
- spec: `specs/vcs/vcs.spec.md` · строк: 308 · scope-type: — · mermaid-блоков: 0 · якорей: 0
...
<!-- Новый ID: `<ACR>-<slug>` — kebab-case, слаг из Meta.Purpose, слаг ≤8 символов (дефисы включительно), уникален в рамках всего репо.
     Назначение вычисляется из ID: `specs/vcs/vcs.task.<новый-ID>.md`. -->
