# План миграции: specs/agent-mon-cli/agent-mon-cli.spec.md
...
- spec: `specs/agent-mon-cli/agent-mon-cli.spec.md` · строк: 251 · scope-type: — · mermaid-блоков: 2 · якорей: 0
...
- тикеты:
  - `tasks/agent-mon-cli/bootstrap.task-48.md` · `AMC-tui-deps` · [ ] TODO · Установить зависимости для TUI: ink@^7, react@^19, @types/react
  <!--/SECTION:INVENTORY-->
...
<!-- Новый ID: `<ACR>-<slug>` — kebab-case, слаг из Meta.Purpose, слаг ≤8 символов (дефисы включительно), уникален в рамках всего репо.
     Назначение вычисляется из ID: `specs/agent-mon-cli/agent-mon-cli.task.<новый-ID>.md`. -->

| Файл                                       | Task-ID | Новый ID     | Назначение                                               |
| ------------------------------------------ | ------- | ------------ | -------------------------------------------------------- |
| `tasks/agent-mon-cli/bootstrap.task-48.md` | TSK-48  | AMC-tui-deps | `specs/agent-mon-cli/agent-mon-cli.task.AMC-tui-deps.md` |
