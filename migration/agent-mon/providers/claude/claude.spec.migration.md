# План миграции: specs/agent-mon/providers/claude/claude.spec.md

- **Status:** APPROVED <!-- PLANNED → MAPPED → APPROVED → DONE -->
- **Scope:** agent-mon | **Module:** claude
...
- spec: `specs/agent-mon/providers/claude/claude.spec.md` · строк: 182 · scope-type: — · mermaid-блоков: 1 · якорей: 0
...
<!-- Новый ID: `<ACR>-<slug>` — kebab-case, слаг из Meta.Purpose, слаг ≤8 символов (дефисы включительно), уникален в рамках всего репо.
     Назначение вычисляется из ID: `specs/agent-mon/providers/claude/claude.task.<новый-ID>.md`. -->
