# План миграции: specs/agent-mon/providers/opencode/opencode.spec.md

- **Status:** APPROVED <!-- PLANNED → MAPPED → APPROVED → DONE -->
- **Scope:** agent-mon | **Module:** opencode
...
- spec: `specs/agent-mon/providers/opencode/opencode.spec.md` · строк: 157 · scope-type: — · mermaid-блоков: 1 · якорей: 0
...
<!-- Новый ID: `<ACR>-<slug>` — kebab-case, слаг из Meta.Purpose, слаг ≤8 символов (дефисы включительно), уникален в рамках всего репо.
     Назначение вычисляется из ID: `specs/agent-mon/providers/opencode/opencode.task.<новый-ID>.md`. -->
