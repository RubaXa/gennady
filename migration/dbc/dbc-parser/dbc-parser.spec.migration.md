# План миграции: specs/dbc/dbc-parser/dbc-parser.spec.md

- **Status:** APPROVED <!-- PLANNED → MAPPED → APPROVED → DONE -->
- **Scope:** dbc | **Module:** dbc-parser
...
- spec: `specs/dbc/dbc-parser/dbc-parser.spec.md` · строк: 196 · scope-type: — · mermaid-блоков: 1 · якорей: 0
...
- тикеты:
  - `tasks/dbc/dbc-parser/dbc-parser.task-01.md` · `DP-fields` · — · Добавить в `dbc-parser.types.ts` поля `format` и `inline` согласно новой схеме из discovery.
  - `tasks/dbc/dbc-parser/dbc-parser.task-02.md` · `DP-jsdoc` · — · Выровнять `DbcJsDocParser` с новой схемой: парсить `@implements`, обновить порядок тегов, определять `format`, парсить `inline` записи.
  - `tasks/dbc/dbc-parser/dbc-parser.task-03.md` · `DP-snaps` · — · Актуализировать все snapshot-тесты под изменения из DP-fields и DP-jsdoc. Новые кейсы: `@implements`, `format`, `inline`, обновлённый `CONTRACT_ORDER`.
  <!--/SECTION:INVENTORY-->
...
<!-- Новый ID: `<ACR>-<slug>` — kebab-case, слаг из Meta.Purpose, слаг ≤8 символов (дефисы включительно), уникален в рамках всего репо.
     Назначение вычисляется из ID: `specs/dbc/dbc-parser/dbc-parser.task.<новый-ID>.md`. -->

| Файл                                         | Task-ID | Новый ID  | Назначение                                          |
| -------------------------------------------- | ------- | --------- | --------------------------------------------------- |
| `tasks/dbc/dbc-parser/dbc-parser.task-01.md` | TSK-01  | DP-fields | `specs/dbc/dbc-parser/dbc-parser.task.DP-fields.md` |
| `tasks/dbc/dbc-parser/dbc-parser.task-02.md` | TSK-02  | DP-jsdoc  | `specs/dbc/dbc-parser/dbc-parser.task.DP-jsdoc.md`  |
| `tasks/dbc/dbc-parser/dbc-parser.task-03.md` | TSK-03  | DP-snaps  | `specs/dbc/dbc-parser/dbc-parser.task.DP-snaps.md`  |
