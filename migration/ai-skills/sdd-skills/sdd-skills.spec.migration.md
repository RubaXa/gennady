# План миграции: specs/ai-skills/sdd-skills/sdd-skills.spec.md

- **Status:** APPROVED <!-- PLANNED → MAPPED → APPROVED → DONE -->
- **Scope:** ai-skills | **Module:** sdd-skills
...
- spec: `specs/ai-skills/sdd-skills/sdd-skills.spec.md` · строк: 261 · scope-type: — · mermaid-блоков: 1 · якорей: 10
...
- тикеты:
  - `tasks/ai-skills/sdd-skills/sdd-skills.task-61.md` · `SS-run-all` · [ ] TODO · Переделать `sdd verify` с fail-fast на run-all с подавлением успешного вывода
  <!--/SECTION:INVENTORY-->
...
<!-- Новый ID: `<ACR>-<slug>` — kebab-case, слаг из Meta.Purpose, слаг ≤8 символов (дефисы включительно), уникален в рамках всего репо.
     Назначение вычисляется из ID: `specs/ai-skills/sdd-skills/sdd-skills.task.<новый-ID>.md`. -->

| Файл                                               | Task-ID | Новый ID   | Назначение                                                 |
| -------------------------------------------------- | ------- | ---------- | ---------------------------------------------------------- |
| `tasks/ai-skills/sdd-skills/sdd-skills.task-61.md` | TSK-61  | SS-run-all | `specs/ai-skills/sdd-skills/sdd-skills.task.SS-run-all.md` |
