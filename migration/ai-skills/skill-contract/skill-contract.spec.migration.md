# План миграции: specs/ai-skills/skill-contract/skill-contract.spec.md

- **Status:** APPROVED <!-- PLANNED → MAPPED → APPROVED → DONE -->
- **Scope:** ai-skills | **Module:** skill-contract
...
- spec: `specs/ai-skills/skill-contract/skill-contract.spec.md` · строк: 322 · scope-type: — · mermaid-блоков: 1 · якорей: 10
...
<!-- Новый ID: `<ACR>-<slug>` — kebab-case, слаг из Meta.Purpose, слаг ≤8 символов (дефисы включительно), уникален в рамках всего репо.
     Назначение вычисляется из ID: `specs/ai-skills/skill-contract/skill-contract.task.<новый-ID>.md`. -->
